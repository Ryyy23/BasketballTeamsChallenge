                    ...
                    <tbody>
                        <tr v-for="user in users" :key="user.id">
                            ...
                            <select @change="changeRole(user.id, $event)">
                                <option :selected="user.role.teammanager" value="teammanager">Team Manager</option>
                                <option :selected="user.role.teammember" value="teammember">Team Member</option>
                                <option :selected="user.role.newmember" value="newmember">New Member</option>
                                <option :selected="user.role.rejected" value="rejected">Reject Member</option>
                            </select>
                        </tr>
                    </tbody>
                </table>
